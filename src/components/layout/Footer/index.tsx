...
const socialsData: SocialNetworks[] = [
  ...
  },
  {
    id: 2,
    icon: <FaFacebookF />,
    url: "https://www.facebook.com/profile.php?id=61570566846277&mibextid=ZbWKwL",
  },
  {
    id: 3,
    icon: <FaInstagram />,
    url: "https://www.instagram.com/ye_amnahh?igsh=MXdmZGFhcHg3cGZzdA==",
  },
  {
    id: 4,
    icon: <FaGithub />,
    url: "https://github.com/yamnasarwar745",
  },
];
